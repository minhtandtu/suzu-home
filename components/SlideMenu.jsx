        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen mt-20 mb-4">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white  shadow-xl">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6 ">
                      ...
                      <div className="absolute inset-0 px-4 sm:px-6">
                        ...
                        >
                          {/* Menu */}
                          <div className="m-1 w-full flex pt-3  lg:overflow-hidden  bg-white opacity-90 border border-gray-200 rounded-t-2xl shadow-xl ">
                            <div className="  w-[70%] sm:w-[50%] text-left ml-4">
                              {Menu.map((item) => (
                                <h3
                                  key={item.name}
                                  className="my-3 first:text-red-500 first:font-semibold  hover:text-red-500"
                                >
                                  {item.name}
                                </h3>
                              ))}
                            ...
                            <div className=" w-[50%]   bg-gray-200 hidden sm:block ">
                              <div className="h-[50%] "></div>
                              <div className=" block  ">
                                {Contact.map((contact) => (
                                  <p
                                    key={contact.property}
                                    className="text-gray-500 text-base p-3 font-semibold"
                                  >
